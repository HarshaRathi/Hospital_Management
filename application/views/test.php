    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>User/addtest"> <i class="fa fa-plus"></i> Add New</a>
        ...
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>User/test" method="POST" id="searchList">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover" id="tblMain" style="cursor: pointer;">
                    <tr>
                        <th id="CN_col_head">Test ID</th>
                        <th id="BN_col_head">Test Name</th>
                        <th id="PI_col_head">Cost</th>
                        <?php
			...
			?>
                    ...
                    ?>
                    <tr>
                        <td class="CN_col"><?php echo $record->Test_id?></td>
                        <td class="BN_col"><?php echo $record->Test_name ?></td>
			...
			?>
                        <td class="text-center">
                            <a class="btn btn-sm btn-info" href="#" title="Edit"><i class="fa fa-pencil"></i></a></td>
                            <td class="text-center">   <a class="btn btn-sm btn-danger deleteUser" href="<?php echo base_url().'User/deleteTest/'.$record->Test_id; ?>" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                        <?php } ?>
                    </tr>
                    <?php
