            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url(); ?>User/addNewWB" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                    <div class="col-md-6">                                
                                        <div class="form-group">
                                            <label for="Wardboy_id">Ward Boy ID</label>
                                            <input type="text" class="form-control required" value="<?php echo set_value('Wardboy_id'); ?>" id="Wardboy_id" name="Wardboy_id" maxlength="128" required>
                                         </div>
                                    
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="Wardboy_name">Ward Boy Name</label>
                                            <input type="text" class="form-control required" id="Wardboy_name" name="Wardboy_name" value="<?php echo set_value('Wardboy_name'); ?>" maxlength="128" required>
                                        </div>
                                    </div>
                            </div>
                                    <div class="row">
