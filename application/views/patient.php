        ...
        <div class="row">
            ...
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>User/addPatient"> <i class="fa fa-plus"></i> Add New</a>
                ...
                <input type="checkbox" value="hide" id="PD_col" onchange="hide_show_table(this.id);" checked>Disease &nbsp&nbsp&nbsp&nbsp
                <input type="checkbox" value="hide" id="WL_col" onchange="hide_show_table(this.id);" checked>Address &nbsp&nbsp&nbsp&nbsp
                <input type="checkbox" value="hide" id="CT_col" onchange="hide_show_table(this.id);" checked>City &nbsp&nbsp&nbsp&nbsp
        ...
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>User/patients" method="POST" id="searchList">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover" id="tblMain" style="cursor: pointer;">
                    <tr>
                        ...
                        <th id="PD_col_head">Disease</th>
                        <th id="WL_col_head">Address</th>
                        <th id="CT_col_head">City</th>
			...
			?>
                    ...
                    <tr>
                        ...
                        <td class="PD_col"><?php echo $record->Disease ?></td>
                        <td class="WL_col"><?php echo $record->Address?></td>
                        <td class="CT_col"><?php echo $record->City?></td>
			...
			?>
                        <td class="text-center">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'User/editpatient/'.$record->Pat_id; ?>" title="Edit"><i class="fa fa-pencil"></i></a></td>
                            <td class="text-center">   <a class="btn btn-sm btn-danger deleteUser" href="<?php echo base_url().'User/deletePatient/'.$record->Pat_id; ?>" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                        <?php } ?>
                    </tr>
                    <?php
