...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Patient Test Management
        ...
        <div class="row">
            ...
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>User/addptest"> <i class="fa fa-plus"></i> Add New</a>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Patients Test List</h3>
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>User/p_test" method="POST" id="searchList">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover" id="tblMain" style="cursor: pointer;">
                    <tr>
                        <th id="CN_col_head">Patient ID</th>
                        <th id="BN_col_head">Test ID</th>
                    ...
                    ?>
                    <tr>
                        <td class="CN_col"><?php echo $record->Pat_id?></td>
                        <td class="BN_col"><?php echo $record->Test_id ?></td>
