...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Discharged Patient Management
        ...
        <div class="row">
            ...
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>User/adddpatient"> <i class="fa fa-plus"></i> Add New</a>
        ...
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>User/d_patient" method="POST" id="searchList">
			...
			?>
                    ...
                    <tr>
                        ...
                        <td class="WL_col"><?php echo $record->Discharge_date ?></td>
                        ...
                        <td class="NR_col"><?php echo $record->Total_bill ?></td>
                        ...
                        <td class="NR_col"><?php echo $record->Admitted_Patient ?></td>
                         <?php
				if ($role == "admin.hospital@gmail.com"){

			?>
                        <td class="text-center">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'User/editdpatient/'.$record->Pat_id; ?>" title="Edit"><i class="fa fa-pencil"></i></a></td>
                            <td class="text-center">   <a class="btn btn-sm btn-danger deleteUser" href="<?php echo base_url().'User/deleteDPatient/'.$record->Pat_id; ?>" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                        <?php } ?>
                    </tr>
                    <?php
