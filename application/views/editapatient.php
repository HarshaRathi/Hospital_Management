...
$Admit_date = $userInfo->Admit_date;
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Add / Edit Admit Patient</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Admit Patient Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addOffer" action="<?php echo base_url(); ?>User/editoldapatient" method="post">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="Admit_date" name="Admit_date" value="<?php echo $Admit_date; ?>" maxlength="128" readonly>
                                    </div>
                                </div>
                            </div>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="Ward_id" name="Ward_id" maxlength="128"  value="<?php echo $Ward_id; ?>" >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                               ...
                               <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="Room_no" name="Room_no" maxlength="128"  value="<?php echo $Room_no; ?>" >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
